...
#ifndef _CX32L003_FLASH_H
#define _CX32L003_FLASH_H
...
#define IS_FLASH_ADDRESS(ADDRESS) (((ADDRESS) >= 0x00000000) && ((ADDRESS) <= 0x000010000))
...
#define IS_FLASH_FLAG_IT(FLAG) ((FLAG == FLASH_FLAG_IT_PC )||\
                                (FLAG == FLASH_FLAG_IT_PROTECT )||\
                                (FLAG == FLASH_FLAG_ALL))
