  ...
  * @version V0.0.0
  * @date    04-August-2018
  * @brief   This file provides all the CLKTRIM firmware functions. 
  *              
  ===============================================================================
 */
...
/**
  ...
  * @retval None
  */
 void ClkTrim_ClkConfig(CLKTRIM_TypeDef*CLKTRIMx,\
						uint32_t Refclk,\
						uint32_t Calclk)
{
  uint32_t tmpreg = 0;
...
/**
  * @brief  Set Rload count value to the clktrim register
  * @param  CLKTRIMx: Select the CLKTRIM peripheral.
  * @param  Value:  the value to the CLKTRIM Register
  * @retval None
  */ 
