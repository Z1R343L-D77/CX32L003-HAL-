...
{ 
  ...
  if ((TIMx->RAWINTSR & TIM_ITFLAG) != (uint16_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
/**
  ...
  * @param  TIMx: Select the TIM peripheral
	*         This parameter can be one of the following values: TMER0,TMER1.
  * @param  TIM_ITFLAG: TIM interrupt flag
  * @retval The new state of TIM_ITFLAG (SET or RESET).
  */
...
{ 
  ...
  if ((TIMx->MSKINTSR & TIM_ITFLAG) != (uint16_t)RESET)
  {
    bitstatus = SET;
  }
  else
...
/**
  ...
  * @param  TIMx: Select the TIM peripheral
	*         This parameter can be one of the following values: TMER0,TMER1.
  * @param  TIM_ITFLAG: The state of TIM interrupt
  * @retval None
  */
...
{  
  ...
  /* Clear the flags */
  TIMx->INTCLR = (uint32_t)(0x01&TIM_ITFLAG);
}
